...
// const SignUp = ({ onSwitchToLogin }) => { // Passed down a prop to switch to login form
...
//     // Call the function to switch to the login form
...
//       <p>Already a member? <a href='#' onClick={onSwitchToLogin}>Login now</a></p>
//     </form>
//     </div>
//     </div>
//       )}
